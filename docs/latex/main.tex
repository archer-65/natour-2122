...
% \begin{equation} \label{eq: exemple}
	...
	NaTour21 si configura come community in cui chiunque può intraprendere la passione per l'escursionismo o condividerla.\\\\
	Cionostante, si individua come target degli utenti la popolazione italiana di escursionisti, caratterizzata da un 
	...
	L'Istat, Istituto Nazionale di Statistica, ha conteggiato nell'anno 2020\footnote{Fonte: \href{http://dati.istat.it/Index.aspx?DataSetCode=DCCV_ESC_CAPI}{sito ufficiale Istat}.}
	circa \texttt{41194} escursioni giornaliere,
	...
	Il motivo prevalente per queste escursioni risulta essere \textit{piacere personale, svago e tempo libero}, con un numero
