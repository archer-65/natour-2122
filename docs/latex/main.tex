...
In questa sezione viene presentato un diagramma realizzato con lo scopo di rappresentare la struttura generale dell'architettura realizzata; in esso sono stati 
messi in evidenza i servizi di cui si è usufruito nello sviluppo del software. \\ 
...
\begin{figure}[!htbp]
	\centering
	 \includepdf[pages=1]{./diagrams/spring.pdf}
\end{figure}
...
L'integrazione dei due pattern architetturali sopracitati culmina nella nascita di un nuovo pattern, chiamato \textbf{UDF}. \\

\newpage
\subsection{Dettagli ulteriori scelte implementative}
