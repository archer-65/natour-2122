...
% Il contesto immaginato per l’utilizzo dell applicazione è dare la possibilità ad appassionati di escursionismo di poter accedere in
...
\begin{figure}[!htpb]
	...
	\caption{Eliminazione itinerario personale - Elimina itinerario altrui (admin)}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htpb]
	...
	\caption{Salva itinerario in compilation}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/registrazione.svg}
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/password_dimenticata.svg}
	\caption{Password dimenticata}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/logout.svg}
	\caption{Logout}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/dettagli_itinerario.svg}
	\caption{Dettagli itinerario}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/ricerca_itinerario.svg}
	\caption{Ricerca itinerario}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/valuta_itinerario.svg}
	\caption{Valutazione itinerario}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/segnala_itinerario.svg}
	\caption{Segnalazione itinerario}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/elimina_itinerario.svg}
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/home_(post_recenti).svg}
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/crea_post.svg}
	\caption{Aggiunta post}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/dettagli_post.svg}
	\caption{Dettagli post}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/crea_compilation.svg}
	\caption{Aggiunta compilation}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=\textwidth, height=21cm]{./diagrams/design/ricerca_destinatario_messaggio.svg}
	\caption{Ricerca destinatario messaggio}
\end{figure}
\FloatBarrier
